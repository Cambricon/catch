...
class TestReluModel(nn.Module):
    def __init__(self):
        super(TestReluModel, self).__init__()

    def forward(self, x):
        z = torch.relu(x)
        return z

class TestNNReluModel(nn.Module):
    def __init__(self):
        super(TestNNReluModel, self).__init__()
...
class TestInplaceRelu(nn.Module):
    def __init__(self):
        super(TestInplaceRelu, self).__init__()
